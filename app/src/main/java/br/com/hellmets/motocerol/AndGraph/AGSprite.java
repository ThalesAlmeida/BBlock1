	...
	******************************************/
	private void generateFrames()
	{
		...
		for (int iIndex = 0; iIndex < vetTextures.length - 1; iIndex++)
		{
			...
			vetTextures[iIndex][NONE] = AGNioBuffer.criaBuffer(vetCoords);
			...
			vetCoords[7] = fCoordY1;	
			vetTextures[iIndex][HORIZONTAL] = AGNioBuffer.criaBuffer(vetCoords);
			...
			vetTextures[iIndex][VERTICAL] = AGNioBuffer.criaBuffer(vetCoords);
			...
			vetCoords[6] = fCoordX1;
			vetCoords[7] = fCoordY2;
			vetTextures[iIndex][VERTICAL_HORIZONTAL] = AGNioBuffer.criaBuffer(vetCoords);
		}
		...
		vetCoords[6] = 1;
		vetCoords[7] = 0;
		vetTextures[vetTextures.length - 1][NONE] = AGNioBuffer.criaBuffer(vetCoords);
		...
		vetCoords[6] = 0;
		vetCoords[7] = 0;
		vetTextures[vetTextures.length - 1][HORIZONTAL] = AGNioBuffer.criaBuffer(vetCoords);
		...
		vetCoords[6] = 1;
		vetCoords[7] = 1;
		vetTextures[vetTextures.length - 1][VERTICAL] = AGNioBuffer.criaBuffer(vetCoords);
		...
		vetCoords[6] = 0;
		vetCoords[7] = 1;
		vetTextures[vetTextures.length - 1][VERTICAL_HORIZONTAL] = AGNioBuffer.criaBuffer(vetCoords);
	}
